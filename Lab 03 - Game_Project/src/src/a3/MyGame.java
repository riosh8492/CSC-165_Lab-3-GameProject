...
public class MyGame extends VariableFrameRateGame
{
    ...
    {    	
		...
		Entity dolphinE = sm.createEntity("myDolphin", "BasicModelUVMapping.obj"); // dolphinHighPoly.obj-BasicModelUVMapping.obj
		...
		dolphinN.setLocalScale(0.2f, 0.2f, 0.2f); // SCALE DOWN -> TESTING.
        dolphinN.moveBackward(0.5f);
        dolphinN.attachObject(dolphinE); // Attach node to model entity
        
        TextureManager tm = eng.getTextureManager();
        Texture mainTexture = tm.getAssetByPath("CubModelUV.png"); // CubModelUV.png - Dolphin_HighPolyUV.png
